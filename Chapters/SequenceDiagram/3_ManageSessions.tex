...
\subsection*{Mô tả sơ đồ tuần tự: Tạo lớp học}

\subsubsection*{Hiển thị form tạo lớp}
...
\subsubsection*{Điền thông tin và lưu}
...
\subsubsection*{Kiểm tra tính hợp lệ}
...
\subsubsection*{Xử lý theo điều kiện}
\textbf{Trường hợp 1:} Thông tin hợp lệ (\texttt{validationStatus = valid})
...
\textbf{Trường hợp 2:} Thông tin không hợp lệ (\texttt{validationStatus = invalid})
...
\end{figure}
\subsection*{Mô tả sơ đồ tuần tự: Quản lý lớp học}

\subsubsection*{Hiển thị danh sách lớp}
\begin{itemize}
...
\subsubsection*{Xem chi tiết lớp (tùy chọn)}
\begin{itemize}
...
\subsubsection*{Dùng chức năng huỷ / chỉnh sửa (tùy chọn)}
\begin{itemize}
...
\subsubsection*{Sửa thông tin và lưu}
\begin{itemize}
...
\end{figure}
\subsection*{Mô tả sơ đồ tuần tự: Quản lý lịch rảnh}

\subsubsection*{Hiển thị danh sách lịch rảnh}
...
\subsubsection*{Thêm lịch rảnh mới}
1. Tutor gửi yêu cầu
\begin{itemize}
...
\textbf{Trường hợp 1:} Không trùng lịch (\texttt{duplicateStatus = false})
\begin{itemize}
...
\textbf{Trường hợp 2:} Trùng lịch (\texttt{duplicateStatus = true})
\begin{itemize}
