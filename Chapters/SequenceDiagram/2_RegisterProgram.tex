...
\end{figure}
\subsection*{Mô tả sơ đồ tuần tự: Tìm kiếm chương trình}
...
\end{figure}
\subsection*{Mô tả sơ đồ tuần tự: Đăng ký chương trình}
...
\begin{itemize}
    ...
    \item \textbf{Gọi Service:} \texttt{Controller} gọi \texttt{processRegistration} của \texttt{Service} (\texttt{RegisterProgramService}).
