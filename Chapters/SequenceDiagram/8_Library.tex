...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{graphics/SequenceDiagram/Library/Seq_diagram_Upload.png}
    \caption{Sơ đồ tuần tự cho use-case "Tải tài liệu lên hệ thống"}
    \label{fig:library_management_sequence_diagram}
\end{figure}

\subsection*{Mô tả sơ đồ tuần tự: Tải tài liệu lên hệ thống}
\begin{itemize}
...
\end{figure}
\newpage
\subsection*{Mô tả sơ đồ tuần tự: Tìm kiếm và xem tài liệu}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{graphics/SequenceDiagram/Library/Seq_diagram_Download.png}
    \caption{Sơ đồ tuần tự cho use-case "Tải tài liệu xuống hệ thống"}
    \label{fig:library_management_sequence_diagram_3}
\end{figure}

\subsection*{Mô tả sơ đồ tuần tự: Tải tài liệu xuống hệ thống}
\begin{itemize}
